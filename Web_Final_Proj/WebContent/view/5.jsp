...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row">
    <div class="w3-third">
      <img src="psccbk/psccbk1.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk4.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk7.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>

    <div class="w3-third">
       <img src="psccbk/psccbk2.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk5.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk8.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>
    
    <div class="w3-third">
        <img src="psccbk/psccbk3.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk6.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="psccbk/psccbk9.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>
  </div>
