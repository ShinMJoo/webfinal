...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row">
    <div class="w3-third">
      <img src="../images/menu/psccbk1.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk4.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk7.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>

    <div class="w3-third">
       <img src="../images/menu/psccbk2.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk5.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk8.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>
    
    <div class="w3-third">
        <img src="../images/menu/psccbk3.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk6.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
       <img src="../images/menu/psccbk9.png" style="width:100%" onclick="onClick(this)" alt="따뜻한 아메리카노 먹으면 빠져든다">
    </div>
  </div>
