...
<body class="header">
	...
	<hr>
	<div class="smallArea">
	<h3>이용약관, 개인정보 수집 및 이용,<br /> 위치정보 이용약관(선택), 프로모션 안내<br /> 메일 수신(선택)에 모두 동의합니다.</h3>
	</div>
	<p><p><hr>
...
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 사랑방손님 및 사랑방손님 관련 제반 서비스를 의미합니다.
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
	...
	<p><p><hr> -->
	<div class = "agreeArea">
		<div class="agree">개인정보 수집 및 이용에 대한 안내</div>
	</div>
	<p class = "check">
	<textarea rows="5" cols="100">
제 1 조 (목적)
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
	...
	<p><p><hr> -->
	<div class = "agreeArea">
		<div class="agree">위치정보 이용약관 동의(선택)</div>
	</div>
	<p class = "check">
	<textarea rows="5" cols="100">
위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 사랑방손님 위치기반 서비스를 이용할 수 있습니다.

제 1 조 (목적)
이 약관은 사랑방손님 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (약관 외 준칙)
...
상호: 사랑방손님 주식회사
주소: 경기도 성남시 분당구 불정로 6 사랑방손님 그린팩토리 (463-867)
전화번호: 1588-3820
